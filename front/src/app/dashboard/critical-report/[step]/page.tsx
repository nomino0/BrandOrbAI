    ...
    <div className="p-6 space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-surface-muted">Critical Report Progress</span>
              <span className="text-sm text-surface-muted">
                {Math.round((currentStepNum / 9) * 100)}% Complete
              </span>
            </div>
            <Progress value={(currentStepNum / 9) * 100} className="h-2" />
          </CardContent>
        </Card>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Display Agent Output if available */}
          {isValidated && step.agentType && agentOutput && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
